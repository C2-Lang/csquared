 ...
 * @details Provides a suite of recursive descent parsing functions for handling
 * expressions with proper operator precedence and associativity. Each function
 * handles a different precedence level in the expression grammar.
 */
 ...
 * @details Entry point for expression parsing. Handles assignments and all
 ...
 * @details Handles assignment operators (=, +=, -=, etc.) with right
 * associativity.
 * @param parser The parser context.
 * @return Pointer to the parsed expression AST node.
 */
 ...
 * @details Handles the logical OR operator with short-circuit evaluation
 * semantics.
 * @param parser The parser context.
 * @return Pointer to the parsed expression AST node.
 */
 ...
 * @details Handles the logical AND operator with short-circuit evaluation
 * semantics.
 * @param parser The parser context.
 * @return Pointer to the parsed expression AST node.
 */
 ...
 * @details Handles postfix operators (++, --), function calls, array indexing,
 * and member access.
 * @param parser The parser context.
 * @return Pointer to the parsed expression AST node.
 */
 ...
 * @details Handles literals, identifiers, parenthesized expressions, and other
 * atomic expressions.
 * @param parser The parser context.
 * @return Pointer to the parsed expression AST node.
 */
