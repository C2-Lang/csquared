 ...
 * @details Provides structures and functions for collecting, storing, and
 * reporting compilation errors with source location information, error
 * categories, and formatted diagnostic output.
 */
 ...
 * @details Categorizes different types of compilation errors that can be
 * reported, ranging from lexical errors to semantic and type-checking errors.
 */
typedef enum {
 ...
 * @details Contains complete information about a single compilation error
 * including source location, error type, and descriptive message.
 */
typedef struct {
 ...
 * @details Single node in a linked list of diagnostic errors collected during
 * compilation.
 */
 ...
 * @details Accumulates all errors encountered during compilation with
 * statistics. Supports iteration and querying of collected errors.
 */
typedef struct {
 ...
 * @details Records an error with source location and message without source
 * context.
 ...
 * @details Records an error with full information including the line of source
 * code.
 * @param reporter The reporter instance.
 * @param type The error type category.
 * @param path Source file path.
