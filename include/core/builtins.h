/**
 * @file builtins.h
 * @brief Built-in function definitions and intrinsic handling for the C²
 * compiler.
 * @details Provides interfaces for recognizing, querying, and generating code
 * for built-in functions and compiler intrinsics like syscall, putc, and inline
 * assembly.
 */
 ...
 * @details Categorizes the different types of built-in functions supported by
 * the compiler.
 */
typedef enum {
 ...
 * @details Determines whether a given function name is a recognized built-in
 * intrinsic.
 ...
 * @details Returns information about argument counts and type for a named
 * built-in.
 ...
 * @details Emits target code for a built-in function invocation with given
 * arguments.
